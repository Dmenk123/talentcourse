          ...
          <div class="kt-portlet__body">
            <div class="kt-section kt-section--first">
              <div class="kt-section__body">
                ...
                <div class="form-group row">
                  <label class="col-xl-3 col-lg-3 col-form-label">Pilih Video</label>
                  <div class="col-lg-9 col-xl-6">
                    <select class="form-control kt-select2" id="sel_video" name="sel_video" style="width: 100%;">
                      <option value="">Silahkan Pilih Video</option>
                    </select>
                    <span class="help-block"></span>
                  </div>
                </div>
