                ...
                <div class="ps-checkout__billing">
                    ...
                    <div class="form-group form-group--inline">
                        ...
                        <div class="custom-file">
                            <input type="file" class="form-control" id="bukti_transfer" style="background-color: #e8f0fe;" name="bukti_transfer" accept=".jpg,.jpeg,.png">
                            <label class="custom-file-label" id="label_bukti_transfer" for="customFile">Pilih gambar yang akan diupload</label>
                        </div>
                    </div>
                    ...
                    <footer>
                        ...
                        <div class="ps-shipping">
                            ...
                            <div class="form-group paypal">
                                <button type="button" class="btn btn-md btn-success" id="pay-button">Proses Data Pembayaran<i class="ps-icon-next"></button>
                            </div>
                        </div>
                    </footer>
                </div>
